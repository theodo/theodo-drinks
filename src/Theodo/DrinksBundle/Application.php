...
use Benjamin\Provider\OAuthSecurityServiceProvider;
...
class Application extends BaseApplication
{
    ...
    public function configureSecurity()
    {
        ...
        $this['oauth.configuration'] = array(
            'resource_owners' => array(
                'google' => array(
                    'type'          => 'google',
                    'client_id'     => $loader['google']['client_id'],
                    'client_secret' => $loader['google']['secret'],
                    'scope'         => 'https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email',
                    'paths'         => array('username' => 'email', 'email' => 'email', 'profilepicture' => 'picture')
                )
            ),
            'firewall_name' => 'front'
        );
